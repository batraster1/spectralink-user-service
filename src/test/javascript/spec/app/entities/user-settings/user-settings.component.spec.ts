...
import { UserSettingsComponent } from 'app/entities/user-settings/user-settings.component';
...
describe('Component Tests', () => {
  describe('UserSettings Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userSettings && comp.userSettings[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
