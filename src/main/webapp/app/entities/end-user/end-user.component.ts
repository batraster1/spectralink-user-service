...
export class EndUserComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.endUserService
      ...
      .subscribe(
        (res: HttpResponse<IEndUser[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IEndUser): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInEndUsers(): void {
    this.eventSubscriber = this.eventManager.subscribe('endUserListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEndUser[] | null, headers: HttpHeaders, page: number): void {
